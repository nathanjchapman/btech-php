...
<html lang="en">
    <head>
        ...
        <link href="/12_final/public/assets/css/styles.css" rel="stylesheet" type="text/css">
        <link href="/12_final/public/assets/css/normalize.css" rel="stylesheet" type="text/css">
        <link href="/12_final/public/assets/css/w3.css" rel="stylesheet" type="text/css">
    </head>
    <body>
        <header>
            <div class="navbar">
                ...
                <div>
                    <a href="#close" title="Close" class="close">X</a>
                        ...
                        <div class="login">
                            ...
                            <form action="/12_final/public/login.php" method="POST">
