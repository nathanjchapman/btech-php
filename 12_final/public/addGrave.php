    ...
    if (isset($_POST['addGrave'])) {
        ...
        if ($uploadOk) {
            ...
            if(move_uploaded_file($tempFile, $target_file)) {
                ...
                //* insert steps
                $query = "insert into graves (firstName, middleName, lastName, birthDate, deathDate, imageName) values(\"". $grave["firstName"] ."\", \"". $grave["middleName"] ."\", \"". $grave["lastName"] ."\", \"". $grave["birthDate"] ."\", \"". $grave["deathDate"] ."\", \"". $imageName ."\")";
