    ...
    if(isset($_FILES["fileToUpload"]["name"]) && !empty($_FILES["fileToUpload"]["name"])) {
        ...
        if ($uploadOk) {
            ...
            if(move_uploaded_file($tempFile, $target_file)) {
                ...
                $birthDate = date('Y-m-d', strtotime($grave["birthDate"]));
                $deathDate = date('Y-m-d', strtotime($grave["deathDate"]));

                //* insert steps for attempting image update
                $query = "update graves set firstName = \"". $queryInfo["firstName"] ."\", middleName = \"". $queryInfo["middleName"] ."\", lastName = \"". $queryInfo["lastName"] ."\", birthDate = \"". $queryInfo["birthDate"] ."\", deathDate = \"". $queryInfo["deathDate"] ."\", imageName = \"". $imageName ."\" where graveID = ". $queryInfo["graveID"];
        ...
        $query = "update graves set firstName = \"". $queryInfo["firstName"] ."\", middleName = \"". $queryInfo["middleName"] ."\", lastName = \"". $queryInfo["lastName"] ."\", birthDate = \"". $queryInfo["birthDate"] ."\", deathDate = \"". $queryInfo["deathDate"] ."\" where graveID = ". $queryInfo["graveID"];
