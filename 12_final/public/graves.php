                ...
                <div><a href="#close" title="Close" class="close">X</a>
                    ...
                    <div class="login Grave scroll">
                        ...
                        <form action="editGrave.php" method="POST" enctype="multipart/form-data">
                            ...
                            <label for="firstName">First Name</label>
                            <input type="text" name="firstName" id="firstName" value="<?php echo $grave['firstName']; ?>">
                            <label for="middleName">Middle Name</label>
                            <input type="text" name="middleName" id="middleName" value="<?php echo $grave['middleName']; ?>">
                            <label for="lastName">Last Name</label>
                            <input type="text" name="lastName" id="lastName" value="<?php echo $grave['lastName']; ?>">
                            <label for="birthDate">Birth Date</label>
                            <input type="date" name="birthDate" id="birthDate" value="<?php echo date('Y-m-d', strtotime($grave['birthDate'])); ?>">
                            <label for="deathDate">Death Date</label>
                            <input type="date" name="deathDate" id="deathDate" value="<?php echo date('Y-m-d', strtotime($grave['deathDate'])); ?>">
                            <label for="fileToUpload">Grave Image</label><br>
                            <img class="editImage" src="assets/img/uploads/<?php echo $grave['imageName']; ?>" alt="Grave headstone">
                            <input type="hidden" name="originalImage" value="<?php echo $grave['imageName']; ?>" >
                            <input type="file" name="fileToUpload" id="fileToUpload" >
